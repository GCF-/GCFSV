    ...
    DateRangePicker.prototype = {
        ...
        clickRange: function (e) {
            ...
            if (label == this.locale.customRangeLabel) {
                ...
                this.updateCalendars();
                /* Duyen update the code */
                if (this.element.is('span')) {
                   this.element.siblings().val(this.startDate.format(this.format) + this.separator + this.endDate.format(this.format));            
                this.hide();
                };  
                /* Duyen update the code */
                if (this.element.is('input'))
        ...
        clickApply: function (e) {
            var elementValue = this.element;
            /* Duyen update the code */
            if (elementValue.is('span')) {
               this.element.siblings().val(this.startDate.format(this.format) + this.separator + this.endDate.format(this.format));            
               this.hide();
            };        
            /* Duyen update the code */
            if (elementValue.is('input'))
                this.element.val(this.startDate.format(this.format) + this.separator + this.endDate.format(this.format));            
            this.hide();
        },
